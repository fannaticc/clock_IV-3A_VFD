...
unsigned char DS3231_GetTime(unsigned char *p)
{
    ...
    *p++ = ':';
    ...
    byte0 = BCDToDecimal(DS3231_GetInfo(0x01));
    sprintf(byte2, "%02d", byte0);
    *p++ = byte2[0];
    *p++ = byte2[1];
    *p++ = ':';
    ...
    byte0 = BCDToDecimal(DS3231_GetInfo(0x00));
    sprintf(byte2, "%02d", byte0);
    *p++ = byte2[0];
    *p++ = byte2[1];
    *p++ = ((void*)0);
...
void DS3231_GetCalendar(unsigned char *p)
{
    ...
    byte0 = BCDToDecimal(DS3231_GetInfo(0x03));
    switch(byte0)
    {
        case 1: *p++ = 'S'; *p++= 'e'; *p++= 'g';
                break;
    ...
    *p++ = '.'; *p++ = ' ';
    byte0 = BCDToDecimal(DS3231_GetInfo(0x04));

    sprintf(byte1, "%02d", byte0);
    *p++ = byte1[0]; *p++ = byte1[1]; *p++ = ' ';
    byte0 = BCDToDecimal(DS3231_GetInfo(0x05));
    ...
    *p++ = '.'; *p++ = ' ';
    ...
    byte0 = BCDToDecimal(DS3231_GetInfo(0x06));
    sprintf(byte1, "%02d", byte0);
    *p++ = byte1[0]; *p++ = byte1[1]; *p = ((void*)0);
}
...
int DS3232_GetTemperature(unsigned char *p)
{
    ...
    temp_msb = DS3231_GetInfo(0x11);
    temp_lsb = DS3231_GetInfo(0x12) >> 6;
