...
# 1 "mcc_generated_files/../step-up.h" 1
# 31 "mcc_generated_files/../step-up.h"
...
# 1 "mcc_generated_files/../hardware.h" 1
# 35 "mcc_generated_files/../hardware.h"
typedef struct {
    _Bool btn1;
    _Bool btn2;
    _Bool btn3;
...
void ADC_ISR(void)
{
    switch (adcState)
    {
    case ADC_BOOST_NEW_VALUE:
        adc_boost_result = ADC_GetConversionResult();
        ADC_SelectChannel(ADC_VIN);
        adcState = ADC_INPUT_NEW_VALUE;
        break;

    case ADC_INPUT_NEW_VALUE:
        adc_input_result = ADC_GetConversionResult();
        ADC_SelectChannel(ADC_BTN);
        adcState = ADC_BTN_NEW_VALUE;
        break;

    case ADC_BTN_NEW_VALUE:
        if(ADC_BTN_TIME)
        {
            adc_btn_result = ADC_GetConversionResult();
            ADC_BTN_TIME = 0;
        }
        ADC_SelectChannel(ADC_BOOST);
        adcState = ADC_BOOST_NEW_VALUE;
        break;
    }
    PIR1bits.ADIF = 0;
    ADCON0bits.GO = 1;
