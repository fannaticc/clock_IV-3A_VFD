...
# 64 "display.c"
    switch(num)
    {
        case '0': LATB = 0b01111101;;
                break;

        case '1': LATB = 0b00010001;;
                break;

        case '2': LATB = 0b11011100;;
                break;

        case '3': LATB = 0b11010101;;
                break;

        case '4': LATB = 0b10110001;;
                break;

        case '5': LATB = 0b11100101;;
                break;

        case '6': LATB = 0b11101101;;
                break;

        case '7': LATB = 0b01010001;;
                break;

        case '8': LATB = 0b11111101;;
                break;

        case '9': LATB = 0b11110101;;
                break;
        default:
            LATB = 0b00000000;;
            break;
...
void AcenderAlgarismo(unsigned char num)
{
  switch (num)
  {
    case 0: LATAbits.LATA7 = 0;
            LATCbits.LATC4 = 1;
            break;

    case 2: LATCbits.LATC4 = 0;
            LATCbits.LATC3 = 1;
            break;

    case 4: LATCbits.LATC3 = 0;
            LATCbits.LATC1 = 1;
            break;

    case 6: LATCbits.LATC1 = 0;
            LATCbits.LATC0 = 1;
            break;
    ...
    case 10: LATAbits.LATA6 = 0;
            LATAbits.LATA7 = 1;
            break;

    default: LATCbits.LATC4 = 0;
             LATCbits.LATC3 = 0;
             LATCbits.LATC1 = 0;
             LATCbits.LATC0 = 0;
             LATAbits.LATA6 = 0;
